<%@ Page Title="" Language="C#" MasterPageFile="~/_MyLayout.Master" AutoEventWireup="true" CodeBehind="NewsCreate.aspx.cs" Inherits="ASP_WebForms_WebTinTuc.Views.NewsCreate" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container">
        ...
        <div class="news_create">
            <asp:TextBox ID="txtUrl" TextMode="Url" placeholder="Địa chỉ hình ảnh" class="news_create_input news_create_img" runat="server"></asp:TextBox>
        </div>
        <div class="news_create">
        ...
        <div class="news_create">
          <div class="news_create_btn">
              <asp:Button ID="btnCreate" OnClick="btnCreate_Click" class="news_create_btn_submit" runat="server" Text="Đăng Bài Viết" />
          </div>
        </div>
